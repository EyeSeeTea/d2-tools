...
export class D2ProgramRules {
    ...
    private getEffects(options: {
        ...
        const { event: d2Event, program, tei, events, metadata } = options;
        ...
        const getEffectsOptions = getEffectsOptionsByProgramType(options, event, selectedOrgUnit);
...
function getEffectsOptionsByProgramType(
    options: {
        event: D2Event;
        program: Program;
        programRulesIds: Maybe<Id[]>;
