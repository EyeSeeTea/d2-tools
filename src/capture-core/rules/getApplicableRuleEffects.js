...
const getDataElementsForRulesExecution = stages =>
    [...stages.values()]
...
const getTrackedEntityAttributesForRulesExecution = attributes =>
...
export const getApplicableRuleEffectsForEventProgram = ({ program, orgUnit, currentEvent }) => {
...
export const getApplicableRuleEffectsForTrackerProgram = (
    { program, stage, orgUnit, currentEvent, otherEvents, attributeValues, enrollmentData },
...
const getApplicableRuleEffects = ({
    ...
    return postProcessRulesEffects(effects, foundationForPostProcessing);
};
