...
const convert = (() => {
    ...
    const getIdProps = apiProgramRuleVariable => ({
        ...
        trackedEntityAttributeId:
            apiProgramRuleVariable.trackedEntityAttribute && apiProgramRuleVariable.trackedEntityAttribute.id,
...
export const storeProgramRulesVariables = async programIds => {
    const query = {
        resource: "programRuleVariables",
        params: {
            fields:
                "id,displayName,programRuleVariableSourceType,valueType," +
