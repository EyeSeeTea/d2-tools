...
const loadTrackedEntityTypesBatch = async idBatch => {
...
const getSideEffects = (() => {
    ...
    const getTrackedEntityAttributeIds = trackedEntityTypes =>
 ...
 */
export const loadTrackedEntityTypes = async trackedEntityTypeIds => {
