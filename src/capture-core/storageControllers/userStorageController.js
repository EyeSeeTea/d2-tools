...
function getStorageName(mainStorageName) {
...
function createStorageController(mainStorageController) {
...
export async function initUserControllerAsync(mainStorageController) {
