...
import { actionTypes as enrollmentNoteActionTypes } from "../../components/WidgetEnrollmentComment/WidgetEnrollmentComment.actions";
...
export const enrollmentDomainDesc = createReducerDescription(
    {
        ...
        [UPDATE_ENROLLMENT_EVENTS_WITHOUT_ID]: (state, { payload: { eventData, uid } }) => {
        ...
        [enrollmentNoteActionTypes.ADD_ENROLLMENT_NOTE]: (state, { payload: { note } }) => ({
            ...state,
            enrollment: {
                ...state.enrollment,
