...
const setCategoryOption = (state, categoryId, categoryOption) => {
    const categories = {
        ...state.categories,
...
const resetCategoryOption = (state, categoryId) => {
...
export const getCurrentSelectionsReducerDesc = appUpdaters =>
    createReducerDescription(
        {
            ...
            [lockedSelectorActionTypes.FROM_URL_UPDATE]: ({ categories, categoriesMeta }, action) => {
                const {
                    ...
                    prevProps: { programId: prevProgramId },
                } = action.payload;

                const categorySelections =
                    selections.programId === prevProgramId ? { categories, categoriesMeta } : {};
            ...
            [lockedSelectorActionTypes.PROGRAM_ID_STORE]: (state, { payload: { programId } }) => ({
                ...state,
                programId,
            }),
