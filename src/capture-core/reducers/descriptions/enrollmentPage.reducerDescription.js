...
export const enrollmentPageDesc = createReducerDescription(
    {
        ...
        [INFORMATION_SUCCESS_FETCH]: (
            state,
            { payload: { enrollmentsSortedByDate, teiDisplayName, tetId } }
        ) => ({
            ...state,
        ...
        [MISSING_MESSAGE_VIEW]: state => ({
            ...state,
            enrollmentPageStatus: enrollmentPageStatuses.MISSING_SELECTIONS,
        }),
        [UPDATE_TEI_DISPLAY_NAME]: (state, { payload: { teiDisplayName } }) => ({
            ...state,
            teiDisplayName,
        }),
        ...
        [DELETE_ENROLLMENT]: (state, { payload: { enrollmentId } }) => ({
            ...state,
            enrollments: [...state.enrollments.filter(item => item.enrollment !== enrollmentId)],
        }),
    },
    "enrollmentPage",
    initialReducerValue
