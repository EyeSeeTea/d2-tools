...
import {
    convertToClientFilters,
    convertSortOrder,
    getCustomColumnsConfiguration,
} from "../../../helpers/TEIFilters";
...
export const initTeiWorkingListsViewAsync = async ({
    ...
    return getTeiListData(
        { programId, orgUnitId, pageSize, page, sortById, sortByDirection, filters: apiFilters },
        {
            columnsMetaForDataFetching,
            filtersOnlyMetaForDataFetching,
            querySingleResource,
