...
const useLoadView = ({
    ...
    useEffect(() => {
        ...
        if (triggerLoad) {
            onLoadView(currentTemplate, { programId, programStageId, orgUnitId, categories });
        }
...
export const ListViewLoader = memo(props => {
    const { currentTemplate, programId, programStageId, ...passOnProps } = props;
