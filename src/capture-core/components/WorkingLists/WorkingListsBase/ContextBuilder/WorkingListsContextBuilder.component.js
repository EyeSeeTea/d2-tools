...
export const WorkingListsContextBuilder = props => {
    const {
    ...
    const loadedProgramIdForTemplates = useMemo(
    ...
    const loadedViewContext = useMemo(
        ...
        [loadedContextDefined.programIdView, loadedContextDefined.orgUnitId, loadedContextDefined.categories]
    );

    const templates = useMemo(() => allTemplates && allTemplates.filter(t => !t.deleted), [allTemplates]);
