...
export const retrieveTemplatesEpic = (action$, store, { querySingleResource }) =>
    action$.pipe(
...
export const updateTemplateEpic = (action$, store, { mutate }) =>
    action$.pipe(
            ...
            ({
                ...
                const requestPromise = mutate({
                    ...
                    .then(() => {
                        ...
                        return updateTemplateSuccess(id, eventQueryCriteria, {
                            storeId,
                            isActiveTemplate,
                        });
                    })
                    .catch(error => {
                        ...
                        const isActiveTemplate =
                            store.value.workingListsTemplates[storeId].selectedTemplateId === id;
                        return updateTemplateError(id, eventQueryCriteria, {
                            storeId,
                            isActiveTemplate,
                        });
                    });
...
export const addTemplateEpic = (action$, store, { mutate }) =>
    action$.pipe(
...
export const deleteTemplateEpic = (action$, store, { mutate }) =>
    action$.pipe(
