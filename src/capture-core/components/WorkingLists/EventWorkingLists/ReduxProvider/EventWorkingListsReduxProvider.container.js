...
export const EventWorkingListsReduxProvider = ({ storeId, program, programStage, orgUnitId }) => {
    ...
    const currentTemplate =
        currentTemplateId && templates && templates.find(template => template.id === currentTemplateId);
