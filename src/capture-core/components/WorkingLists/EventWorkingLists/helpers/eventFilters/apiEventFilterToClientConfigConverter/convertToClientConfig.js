...
const getAssigneeFilter = async (assignedUserMode, assignedUsers) => {
...
const getDataElementFilters = (filters, columnsMetaForDataFetching) => {
    if (!filters) {
        return [];
    }
...
// eslint-disable-next-line complexity
const getMainDataFilters = async (eventQueryCriteria, columnsMetaForDataFetching) => {
...
export async function convertToClientConfig(eventQueryCriteria, columnsMetaForDataFetching) {
