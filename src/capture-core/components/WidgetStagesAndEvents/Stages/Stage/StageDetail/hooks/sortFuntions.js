...
const sortNumber = (clientValueA, clientValueB, direction, options) => {
...
const sortText = (clientValueA, clientValueB, direction, options) => {
    const { eventDateA, eventDateB } = options;
...
const sortTime = (clientValueA, clientValueB, direction, options) => {
    const { eventDateA, eventDateB } = options;
...
const sortOrgUnit = (clientValueA, clientValueB, direction, options) =>
    sortText(clientValueA.name, clientValueB.name, direction, options);

// desc: Scheduled -> Active -> Completed -> Skipped
const sortStatus = (clientValueA, clientValueB, direction, options) => {
...
const sortDataFromEvent = ({ dataA, dataB, type, columnName, direction }) => {
    if (!type) {
