...
export const requestAddNoteForEvent = (itemId, dataEntryId, note) =>
    actionCreator(actionTypes.REQUEST_ADD_NOTE_FOR_EVENT)({ itemId, dataEntryId, note });

export const startAddNoteForEvent = (eventId, serverData, selections, context) =>
    actionCreator(actionTypes.START_ADD_NOTE_FOR_EVENT)(
        { selections, context },
        {
            offline: {
                effect: {
