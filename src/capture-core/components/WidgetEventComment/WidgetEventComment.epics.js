...
import { addEventNote, removeEventNote } from "../Pages/ViewEvent/ViewEventComponent/editEvent.actions";

import { addNote, removeNote } from "../DataEntry/actions/dataEntry.actions";
import { getCurrentUser } from "../../d2/d2Instance";

export const addNoteForEventEpic = (action$, store) =>
    action$.pipe(
...
export const removeNoteForEventEpic = action$ =>
    action$.pipe(
