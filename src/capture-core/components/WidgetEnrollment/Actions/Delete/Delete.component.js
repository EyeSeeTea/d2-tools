...
export const Delete = ({ enrollment, onDelete }) => {
    ...
    return (
        <div>
            ...
            {toggle && (
                <Modal small onClose={() => setToggle(false)} dataTest="widget-enrollment-actions-modal">
                    ...
                    <ModalActions>
                        <ButtonStrip end>
                            ...
                            <Button destructive onClick={() => onDelete(enrollment)}>
