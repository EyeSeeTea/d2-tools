...
class SortLabelWrapperPlain extends React.Component {
    getIconClickHandler = (direction, onSort) => () => {
        if (!this.props.disabled) {
            onSort(direction);
        }
    };

    getActiveIcons = (direction, onSort) => {
    ...
    getIcons = (isActive, direction, onSort) => {
        if (isActive) {
