...
export const makeGetCompulsory = () =>
    createDeepEqualSelector(sectionIsCompulsorySelector, sectionCompulsoryFields => sectionCompulsoryFields);
...
export const makeGetDisabled = () =>
    createDeepEqualSelector(sectionIsDisabledSelector, sectionDisabledFields => sectionDisabledFields);
...
export const makeGetHiddenFieldsValues = () =>
    createDeepEqualSelector(sectionHiddenFieldsSelector, sectionHiddenFields => sectionHiddenFields);

const createMessagesDeepEqualSelector = createSelectorCreator(defaultMemoize, (prevValues, currentValues) =>
...
export const makeGetMessages = () =>
    createMessagesDeepEqualSelector(sectionRulesMessagesSelector, sectionMessages => sectionMessages);
