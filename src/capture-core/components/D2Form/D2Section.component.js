...
class D2SectionPlain extends React.PureComponent {
    ...
    renderSectionDescription() {
        ...
        return <SectionDescriptionBox description={description} />;
    }
    ...
    render() {
        ...
        if (isHidden) {
            ...
            this.props.onFieldsValidated && this.props.onFieldsValidated({}, this.props.formBuilderId);
            return null;
        }
