...
const isAddFormData = (action, formId) =>
    action.type === formActionTypes.FORM_DATA_ADD && action.payload.formId === formId;

const isRequestFilterFormFieldOrgUnits = (action, formId, elementId) =>
...
const cancelActionFilter = (action, formId, elementId) => {
...
export const filterFormFieldOrgUnitsEpic = action$ =>
    action$.pipe(
