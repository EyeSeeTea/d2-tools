...
class OptionsSelectVirtualizedPlain extends React.Component {
    static getFilteredOptions(options, filterValue) {
        const filterValueLC = filterValue
            .normalize("NFD")
