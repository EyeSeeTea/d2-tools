...
class ListViewMainPlain extends React.PureComponent {
    renderTopBar = () => {
    ...
    renderList = () => {
        const { classes, filters, updatingWithDialog, onSelectRow, customRowMenuContents, ...passOnProps } =
            this.props;

        const ListComponent =
            !customRowMenuContents || !customRowMenuContents.length ? OnlineList : ListWithEndColumnMenu;
