...
class LockedSelectorClass extends Component {
    constructor(props) {
        super(props);
    ...
    handleOpenProgramWarning = baseAction => {
        if (this.dontShowWarning()) {
...
export const LockedSelectorComponent = compose(withLoadingIndicator(() => ({ height: "100px" })))(
    LockedSelectorClass
);
