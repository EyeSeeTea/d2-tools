...
class QuickSelectorPlain extends Component {
    static getSelectedProgram(selectedProgramId) {
            ...
            <Paper className={this.props.classes.paper}>
                <Grid container spacing={0}>
                    <Grid
                        item
                        xs={12}
                        sm={programSelectorWidth * 3}
                        md={programSelectorWidth * 2}
                        lg={programSelectorWidth}
                        className={this.props.classes.programSelector}
                    >
                        <ProgramSelector
                    ...
                    <Grid
                        ...
                        md={width * 2}
                        lg={width}
                        className={this.props.classes.orgUnitSelector}
                    >
                        <OrgUnitSelector
                            selectedOrgUnitId={this.props.selectedOrgUnitId}
