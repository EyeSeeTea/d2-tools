...
export const setOrgUnitFromLockedSelector = (orgUnitId, orgUnit, pageToPush) =>
    actionCreator(lockedSelectorActionTypes.ORG_UNIT_ID_SET)({ orgUnitId, orgUnit, pageToPush });
export const setProgramIdFromLockedSelector = (programId, pageToPush) =>
    actionCreator(lockedSelectorActionTypes.PROGRAM_ID_SET)({ programId, pageToPush });
export const setCategoryOptionFromLockedSelector = (categoryId, categoryOption) =>
    actionCreator(lockedSelectorActionTypes.CATEGORY_OPTION_SET)({ categoryId, categoryOption });

export const resetOrgUnitIdFromLockedSelector = pageToPush =>
    actionCreator(lockedSelectorActionTypes.ORG_UNIT_ID_RESET)({ pageToPush });
export const resetProgramIdFromLockedSelector = pageToPush =>
    actionCreator(lockedSelectorActionTypes.PROGRAM_ID_RESET)({ pageToPush });
export const resetCategoryOptionFromLockedSelector = categoryId =>
...
export const openNewRegistrationPageFromLockedSelector = () =>
    actionCreator(lockedSelectorActionTypes.NEW_REGISTRATION_PAGE_OPEN)();
...
export const updateSelectionsFromUrl = data => actionCreator(lockedSelectorActionTypes.FROM_URL_UPDATE)(data);
export const validSelectionsFromUrl = () =>
    actionCreator(lockedSelectorActionTypes.FROM_URL_CURRENT_SELECTIONS_VALID)();
export const invalidSelectionsFromUrl = error =>
    actionCreator(lockedSelectorActionTypes.FROM_URL_CURRENT_SELECTIONS_INVALID)({ error });
export const setCurrentOrgUnitBasedOnUrl = orgUnit =>
...
export const errorRetrievingOrgUnitBasedOnUrl = error =>
...
// component Lifecycle
export const fetchOrgUnit = orgUnitId =>
    actionCreator(lockedSelectorActionTypes.FETCH_ORG_UNIT)({ orgUnitId });

// enrollment related
export const resetTeiSelection = () => actionCreator(lockedSelectorActionTypes.TEI_SELECTION_RESET)();

export const setEnrollmentSelection = ({ enrollmentId }) =>
...
export const resetProgramIdBatchAction = (actions, pageToPush) =>
    batchActions(
        [
            ...actions,
...
export const resetOrgUnitIdBatchAction = (customActionsOnOrgUnitIdReset, pageToPush) =>
    batchActions(
        [resetOrgUnitIdFromLockedSelector(pageToPush), ...customActionsOnOrgUnitIdReset],
