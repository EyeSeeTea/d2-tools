...
import {
    ...
    updateTei,
    setTeiModalError,
    setTeiAttributeValues,
} from "./dataEntry.actions";
...
export const updateTeiEpic = (action$, store) =>
    action$.pipe(
...
export const updateTeiSucceededEpic = action$ =>
    action$.pipe(
...
export const updateTeiFailedEpic = action$ =>
    action$.pipe(
