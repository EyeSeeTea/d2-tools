...
export const fetchOrgUnit = orgUnitId => actionCreator(actionTypes.FETCH_ORG_UNIT)({ orgUnitId });

export const setCurrentOrgUnit = orgUnit => actionCreator(actionTypes.FETCH_ORG_UNIT_SUCCESS)(orgUnit);
