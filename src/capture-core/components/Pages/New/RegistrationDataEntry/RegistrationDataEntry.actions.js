...
export const registrationFormActionTypes = {
    ...
    NEW_TRACKED_ENTITY_INSTANCE_WITH_ENROLLMENT_SAVE_START:
    ...
    NEW_TRACKED_ENTITY_INSTANCE_WITH_ENROLLMENT_SAVE_COMPLETED:
        "CompleteSavingNewTrackedEntityInstanceWithEnrollment",
    NEW_TRACKED_ENTITY_INSTANCE_WITH_ENROLLMENT_SAVE_FAILED:
        "FailSavingNewTrackedEntityInstanceWithEnrollment",
};
