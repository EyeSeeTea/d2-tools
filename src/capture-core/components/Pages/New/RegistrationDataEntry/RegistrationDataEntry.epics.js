...
export const startSavingNewTrackedEntityInstanceEpic = (action$, store) =>
    action$.pipe(
...
export const completeSavingNewTrackedEntityInstanceEpic = (action$, store) =>
    action$.pipe(
...
export const startSavingNewTrackedEntityInstanceWithEnrollmentEpic = (action$, store) =>
    action$.pipe(
...
export const completeSavingNewTrackedEntityInstanceWithEnrollmentEpic = (action$, store) =>
    action$.pipe(
