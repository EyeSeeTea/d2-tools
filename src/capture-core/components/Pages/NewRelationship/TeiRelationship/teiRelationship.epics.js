...
export const openRelationshipTeiSearchEpic = (action$, store) =>
    action$.pipe(
...
export const requestRelationshipTeiSearchEpic = action$ =>
    action$.pipe(
...
export const TeiRelationshipNewOrEditSearchEpic = action$ =>
    action$.pipe(
