...
export const updateEventNoteField = value => actionCreator(actionTypes.UPDATE_EVENT_NOTE_FIELD)({ value });

export const requestSaveEventNote = note => actionCreator(actionTypes.REQUEST_SAVE_EVENT_NOTE)({ note });

export const startSaveEventNote = (eventId, serverData, selections, clientId) =>
