...
export const eventRelationshipsLoaded = () => actionCreator(actionTypes.EVENT_RELATIONSHIPS_LOADED)();

export const eventCancelNewRelationship = () => actionCreator(actionTypes.EVENT_CANCEL_NEW_RELATIONSHIP)({});

export const requestAddEventRelationship = (relationshipType, entity, entityType) =>
    actionCreator(actionTypes.REQUEST_ADD_EVENT_RELATIONSHIP)({ relationshipType, entity, entityType });

export const eventRelationshipAlreadyExists = message =>
    actionCreator(actionTypes.EVENT_RELATIONSHIP_ALREADY_EXISTS)({ message });

export const saveEventRelationshipNewTei = (clientData, selections, clientId) =>
...
export const startSaveEventRelationship = (serverData, selections, clientId) =>
...
export const requestDeleteEventRelationship = clientId =>
    actionCreator(actionTypes.REQUEST_DELETE_EVENT_RELATIONSHIP)({ clientId });

export const startDeleteEventRelationship = (relationshipId, clientId, selections) =>
