...
class ViewEventNewRelationshipWrapperPlain extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <div className={classes.container}>
                ...
                <Paper className={classes.newRelationshipPaper}>
                    ...
                    <NewRelationship header={i18n.t("New event relationship")} {...passOnProps} />
                </Paper>
                <ConfirmDialog
...
export const ViewEventNewRelationshipWrapperComponent = withStyles(getStyles)(
    ViewEventNewRelationshipWrapperPlain
);
