...
export const viewEventFromUrl = data =>
...
export const eventFromUrlRetrieved = (eventContainer, prevProgramId, categoriesData) =>
    actionCreator(actionTypes.EVENT_FROM_URL_RETRIEVED)({ eventContainer, prevProgramId, categoriesData });

export const orgUnitRetrievedOnUrlUpdate = (orgUnit, eventContainer) =>
...
export const startOpenEventForView = (eventContainer, orgUnit) =>
...
export const openAddRelationship = () => actionCreator(actionTypes.VIEW_EVENT_OPEN_NEW_RELATIONSHIP)();

export const updateEventContainer = (eventContainer, orgUnit) =>
    actionCreator(actionTypes.UPDATE_EVENT_CONTAINER)({ eventContainer, orgUnit });

export const openViewEventPageFailed = error =>
