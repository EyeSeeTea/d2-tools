...
const EventDetailsSectionPlain = props => {
    const { classes, onOpenEditEvent, showEditEvent, programStage, eventAccess, ...passOnProps } = props;
        ...
        return (
            <div className={classes.dataEntryContainer}>
                {showEditEvent ? (
                    ...
                    <EditEventDataEntry formFoundation={formFoundation} orgUnit={orgUnit} {...passOnProps} />
                ) : (
                    // $FlowFixMe[cannot-spread-inexact] automated comment
