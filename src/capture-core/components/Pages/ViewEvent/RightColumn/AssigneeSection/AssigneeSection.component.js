...
const LoadingContents = withLoadingIndicator(null, props => ({ style: props.loadingIndicatorStyle }))(
    Contents
);
...
export class AssigneeSectionComponent extends React.Component {
    renderHeader = () => <ViewEventSectionHeader icon={IconUser24} text={i18n.t("Assignee")} />;
