...
const useComponentLifecycle = () => {
    ...
    const { programHasEnrollments, enrollmentsOnProgramContainEnrollmentId, autoEnrollmentId } =
        useEnrollmentInfo(enrollmentId, programId);
    useEffect(() => {
...
const useComputedEnrollmentPageStatus = () => {
    ...
    }, [enrollmentPageStatus, enrollmentId, teiId, programId]);
};
