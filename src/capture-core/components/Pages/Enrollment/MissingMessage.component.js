...
const useMissingStatus = () => {
    ...
    const { programHasEnrollments, enrollmentsOnProgramContainEnrollmentId, tetId } = useEnrollmentInfo(
        enrollmentId,
        programId
    );
        ...
        <>
            {missingStatus === missingStatuses.MISSING_PROGRAM_SELECTION && (
                <IncompleteSelectionsMessage>
                    {i18n.t(
                        "Choose a program to add new or see existing enrollments for {{teiDisplayName}}",
                        {
                            teiDisplayName,
            ...
            {missingStatus === missingStatuses.TRACKER_PROGRAM_WITH_ZERO_ENROLLMENTS_SELECTED && (
                <IncompleteSelectionsMessage>
                    <div className={classes.lineHeight}>
                        ...
                        <div>
                            <LinkButton className={classes.link} onClick={navigateToProgramRegistrationPage}>
            ...
            {missingStatus === missingStatuses.TRACKER_PROGRAM_OF_DIFFERENT_TYPE_SELECTED && (
                <IncompleteSelectionsMessage>
                    <div className={classes.lineHeight}>
                        {i18n.t(
                            "{{teiDisplayName}} is a {{tetName}} and cannot be enrolled in the {{programName}}. Choose another program that allows {{tetName}} enrollment. ",
                            {
                                teiDisplayName,
                                programName,
                                tetName,
            ...
            {missingStatus === missingStatuses.EVENT_PROGRAM_SELECTED && (
                <IncompleteSelectionsMessage>
                    <div className={classes.lineHeight}>
                        ...
                        <div>
                            <LinkButton className={classes.link} onClick={navigateToEventWorkingList}>
