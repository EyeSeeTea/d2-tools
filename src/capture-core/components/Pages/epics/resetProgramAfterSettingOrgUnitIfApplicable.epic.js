...
export const resetProgramAfterSettingOrgUnitIfApplicableEpic = (action$, store) =>
    action$.pipe(
        ofType(lockedSelectorActionTypes.ORG_UNIT_ID_SET, scopeSelectorActionTypes.ORG_UNIT_ID_SET),
