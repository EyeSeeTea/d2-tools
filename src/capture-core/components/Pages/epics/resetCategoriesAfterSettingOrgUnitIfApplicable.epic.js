...
async function isOptionAssociatedWithOrganisationUnit(categoryOptionId, orgUnitId) {
...
export const resetCategoriesAfterSettingOrgUnitIfApplicableEpic = (action$, store) =>
    action$.pipe(
