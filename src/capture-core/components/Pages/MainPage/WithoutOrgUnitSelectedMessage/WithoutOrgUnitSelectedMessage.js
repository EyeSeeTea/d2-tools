...
const WithoutOrgUnitSelectedMessagePlain = ({ programId, setShowAccessible, classes }) => {
    ...
    return (
        <div className={classes.incompleteMessageContainer} data-test={"without-orgunit-selected-message"}>
