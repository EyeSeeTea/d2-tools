...
export const useEnrollmentAddEventTopBar = (teiId, programId, enrollment) => {
    ...
    const userInteractionInProgress = useSelector(state =>
        dataEntryHasChanges(state, "enrollmentEvent-newEvent")
    );

    const handleResetProgramId = useCallback(
        () => resetProgramIdAndEnrollmentContext("enrollment"),
