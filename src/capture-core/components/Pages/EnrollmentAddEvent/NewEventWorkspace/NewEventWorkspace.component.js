...
const NewEventWorkspacePlain = ({
    ...
    const { events, enrolledAt, occurredAt } = useSelector(
        ({ enrollmentDomain }) => enrollmentDomain?.enrollment
    );
    ...
    return (
        <>
            <Widget noncollapsible header={<WidgetStageHeader stage={stage} />}>
...
export const NewEventWorkspace = withStyles(styles)(NewEventWorkspacePlain);
