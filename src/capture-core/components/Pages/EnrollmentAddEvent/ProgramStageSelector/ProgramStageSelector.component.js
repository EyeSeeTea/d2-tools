...
const ProgramStageSelectorComponentPlain = ({ programStages, onSelectProgramStage, onCancel, classes }) => (
    <div className={classes.container}>
            ...
            return (
                <div key={programStage.id}>
                    ...
                    >
                        <Tooltip
                            title={
                                disableStage ? i18n.t("You can’t add any more events in this program") : ""
                            }
                        >
        ...
        <Button className={classes.cancelbutton} secondary big onClick={onCancel}>
