...
const getDeleteButton = InnerComponent =>
    class DeleteButtonHOC extends React.Component {
        constructor(props) {
            super(props);
            this.state = {
                isOpen: false,
...
export const withDeleteButton = () => InnerComponent => getDeleteButton(InnerComponent);
