...
const runRulesForEditSingleEvent = (store, dataEntryId, itemId, uid, orgUnit, fieldData) => {
...
export const runRulesOnUpdateDataEntryFieldForEditSingleEventEpic = (action$, store) =>
    // $FlowSuppress
    action$.pipe(
...
export const runRulesOnUpdateFieldForEditSingleEventEpic = (action$, store) =>
    // $FlowSuppress
    action$.pipe(
