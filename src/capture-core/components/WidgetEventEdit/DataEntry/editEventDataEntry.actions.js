...
export const openEventForEditInDataEntry = ({
    loadedValues: { eventContainer, dataEntryValues, formValues },
    orgUnit,
    foundation,
    program,
    enrollment,
...
export const prerequisitesErrorOpeningEventForEditInDataEntry = message =>
    actionCreator(actionTypes.PREREQUISITES_ERROR_OPENING_EVENT_FOR_EDIT_IN_DATA_ENTRY)(message);

export const startRunRulesOnUpdateForEditSingleEvent = actionData =>
    actionCreator(actionTypes.START_RUN_RULES_ON_UPDATE)(actionData);

export const requestSaveReturnToMainPage = (itemId, dataEntryId, formFoundation) =>
    actionCreator(actionTypes.REQUEST_SAVE_RETURN_TO_MAIN_PAGE)(
        { itemId, dataEntryId, formFoundation },
        { skipLogging: ["formFoundation"] }
    );

export const startSaveEditEventAfterReturnedToMainPage = (serverData, selections) =>
...
export const startAsyncUpdateFieldForEditEvent = (innerAction, onSuccess, onError) =>
