...
export const cancelEditEventDataEntry = () => actionCreator(actionTypes.CANCEL_EDIT_EVENT_DATA_ENTRY)();

export const requestSaveEditEventDataEntry = (itemId, dataEntryId, formFoundation, orgUnit) =>
    actionCreator(actionTypes.REQUEST_SAVE_EDIT_EVENT_DATA_ENTRY)(
        { itemId, dataEntryId, formFoundation, orgUnit },
        ...
        { selections },
        {
            offline: {
                ...
                commit: {
                    ...
                    meta: { selections, eventId, triggerAction: triggerActionCommit },
                },
                rollback: {
                    type: actionTypes.SAVE_EDIT_EVENT_DATA_ENTRY_FAILED,
                    meta: { selections, eventId, triggerAction: triggerActionRollback },
                },
            },
        }
    );

export const prerequisitesErrorLoadingEditEventDataEntry = message =>
    actionCreator(actionTypes.PREREQUISITES_ERROR_LOADING_EDIT_EVENT_DATA_ENTRY)(message);

export const requestDeleteEventDataEntry = ({ eventId, programId, orgUnitId, teiId, enrollmentId }) =>
...
export const startDeleteEventDataEntry = (eventId, params, selections) =>
    actionCreator(actionTypes.START_DELETE_EVENT_DATA_ENTRY)(
        { eventId },
        {
            offline: {
                effect: {
