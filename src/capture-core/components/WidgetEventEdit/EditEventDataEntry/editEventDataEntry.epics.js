...
import { actionTypes as widgetEventEditActionTypes } from "../WidgetEventEdit.actions";
import {
...
import { updateEventContainer } from "../../Pages/ViewEvent/ViewEventComponent/viewEvent.actions";

export const loadEditEventDataEntryEpic = (action$, store) =>
    action$.pipe(
        ofType(
...
export const saveEditedEventEpic = (action$, store) =>
    action$.pipe(
                ...
                events: [
                    {
                        ...
                        dataValues: formFoundation.getElements().map(({ id }) => ({
                            dataElement: id,
...
export const saveEditedEventSucceededEpic = action$ =>
    action$.pipe(
...
export const saveEditedEventFailedEpic = (action$, store) =>
    action$.pipe(
...
export const requestDeleteEventDataEntryEpic = (action$, store, dependencies) =>
    action$.pipe(
