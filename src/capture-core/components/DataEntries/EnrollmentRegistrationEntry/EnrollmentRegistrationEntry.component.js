                ...
                <>
                    <EnrollmentDataEntry
                        ...
                        onStartAsyncUpdateField={() =>
                            console.log("onStartAsyncUpdateField will be here in the future")
                        }
                        {...rest}
                    />
                    <div className={classes.marginTop}>
                        {onSave && (
                            <Button dataTest="create-and-link-button" primary onClick={onSave}>
                                {saveButtonText}
                            </Button>
                        )}
...
export const EnrollmentRegistrationEntryComponent = compose(
    ...
    withSaveHandler({
        onGetFormFoundation: ({ enrollmentMetadata }) =>
            enrollmentMetadata && enrollmentMetadata.enrollmentForm,
        onIsCompleting: () => true,
    }),
    withStyles(styles)
