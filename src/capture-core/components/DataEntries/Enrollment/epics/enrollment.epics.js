...
import { getCurrentClientValues, getCurrentClientMainData } from "../../../../rules";
import { getDataEntryKey } from "../../../DataEntry/common/getDataEntryKey";

const runRulesOnEnrollmentUpdate = (store, context, fieldData, searchActions = []) => {
...
export const runRulesOnEnrollmentDataEntryFieldUpdateEpic = (action$, store) =>
    action$.pipe(
...
export const runRulesOnEnrollmentFieldUpdateEpic = (action$, store) =>
    action$.pipe(
