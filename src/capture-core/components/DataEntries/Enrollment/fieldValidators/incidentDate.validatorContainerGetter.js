...
const isValidIncidentDate = (value, isFutureDateAllowed) => {
...
export const getIncidentDateValidatorContainer = isFutureIncidentDateAllowed => {
    const validatorContainers = [
        ...
        {
            validator: value => isValidIncidentDate(value, isFutureIncidentDateAllowed),
