...
// actions
export { actionTypes as dataEntryActionTypes } from "./DataEntryWrapper/DataEntry/actions/dataEntry.actions";
...
export { addNoteForNewSingleEventEpic } from "./DataEntryWrapper/DataEntry/epics/addNoteForNewSingleEvent.epics";
