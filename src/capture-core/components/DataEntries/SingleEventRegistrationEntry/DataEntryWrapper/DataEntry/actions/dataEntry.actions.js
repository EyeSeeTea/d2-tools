...
export const startRunRulesOnUpdateForNewSingleEvent = actionData =>
    actionCreator(actionTypes.START_RUN_RULES_ON_UPDATE)(actionData);

export const requestSaveNewEventAndReturnToMainPage = (eventId, dataEntryId, formFoundation) =>
    actionCreator(actionTypes.REQUEST_SAVE_RETURN_TO_MAIN_PAGE)(
        { eventId, dataEntryId, formFoundation },
        { skipLogging: ["formFoundation"] }
    );

export const newEventSavedAfterReturnedToMainPage = selections =>
    actionCreator(actionTypes.NEW_EVENT_SAVED_AFTER_RETURNED_TO_MAIN_PAGE)(null, { selections });

export const startSaveNewEventAfterReturnedToMainPage = (serverData, relationshipData, selections) => {
...
export const startSaveNewEventRelationships = (serverData, selections, triggerAction) =>
...
export const openNewEventInDataEntry = () => actionCreator(actionTypes.OPEN_NEW_EVENT_IN_DATA_ENTRY)();
...
export const requestSaveNewEventAddAnother = (eventId, dataEntryId, formFoundation) =>
...
export const requestSaveNewEventInStage = (eventId, dataEntryId, formFoundation, completed) =>
...
export const startSaveNewEventAddAnother = (serverData, relationshipData, selections, clientId) => {
...
export const startSaveNewEventAndReturnToList = (serverData, relationshipData, selections) => {
    const actionType = actionTypes.START_SAVE_NEW_EVENT_AND_RETURN_TO_LIST;

    return actionCreator(actionTypes.START_SAVE_NEW_EVENT_AND_RETURN_TO_LIST)(
        { selections },
        {
            offline: {
                effect: {
...
export const newEventSavedAddAnother = selections =>
    actionCreator(actionTypes.NEW_EVENT_SAVED_ADD_ANOTHER)(null, { selections });

export const newEventReturnToList = selections =>
...
export const newEventOpenNewRelationship = (eventId, dataEntryId) =>
