...
import { initializeNewRelationship } from "../../../../../Pages/NewRelationship/newRelationship.actions";
import {
...
export const openRelationshipForNewSingleEventEpic = action$ =>
    action$.pipe(
        ofType(newEventDataEntryActionTypes.NEW_EVENT_OPEN_NEW_RELATIONSHIP),
        map(() => initializeNewRelationship())
    );

export const addRelationshipForNewSingleEventEpic = (action$, store) =>
    action$.pipe(
...
export const saveNewEventRelationshipsIfExistsEpic = action$ =>
    action$.pipe(
...
export const saveNewEventRelationshipFinishedEpic = action$ =>
    action$.pipe(
        ofType(
...
export const teiForNewEventRelationshipSavedEpic = action$ =>
    action$.pipe(
