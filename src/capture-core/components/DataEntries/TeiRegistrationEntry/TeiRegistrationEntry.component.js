                ...
                <>
                    ...
                    <TrackedEntityInstanceDataEntry
                        ...
                        onGetUnsavedAttributeValues={() =>
                            console.log(
                                "similar to the withErrorMessagePostProcessor this will come in the future"
                            )
                        }
                        {...rest}
                    />
...
export const TeiRegistrationEntryComponent = compose(
    withErrorMessagePostProcessor(({ trackedEntityName }) => trackedEntityName),
    withDuplicateCheckOnSave(),
    withSaveHandler({
        onGetFormFoundation: ({ teiRegistrationMetadata }) => {
