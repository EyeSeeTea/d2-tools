...
const fieldHorizontalFilter = placement => fieldContainer => fieldContainer.placement === placement;

const fieldVerticalFilter = placement => fieldContainer =>
    fieldContainer.placement === placement && !fieldContainer.section;

class DataEntryPlain extends React.Component {
    ...
    getFieldSectionsWithPlacement(placement) {
    ...
    renderDataEntryFieldsByPlacement = placement => {
        const fields = this.props.fields || [];
    ...
    render() {
        ...
        if (!itemId) {
            return <div>{DataEntryPlain.errorMessages.NO_ITEM_SELECTED}</div>;
        }

        if (!formFoundation) {
            return <div>{DataEntryPlain.errorMessages.FORM_FOUNDATION_MISSING}</div>;
        }
            ...
            <div className={directionClasses.container}>
                ...
                <div className={classes.footerBar}>
                    ...
                    <div className={classes.footerRight}>
                        {(() => {
                            if (deleteButton) {
                                return <div className={classes.button}>{deleteButton}</div>;
                            }
                            return null;
                        })()}
                    </div>
