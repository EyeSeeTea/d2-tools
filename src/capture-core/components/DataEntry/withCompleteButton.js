...
const getCompleteButton = (InnerComponent, optionFn) =>
    class CompleteButtonBuilder extends React.Component {
        constructor(props) {
            super(props);
...
const mapStateToProps = (state, props) => {
    ...
    return {
        ...
        completionAttempted:
            state.dataEntriesUI && state.dataEntriesUI[key] && state.dataEntriesUI[key].completionAttempted,
        warnings:
