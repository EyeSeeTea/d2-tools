...
const InfoBoxPlain = ({ scheduleDate, suggestedScheduleDate, eventCountInOrgUnit, orgUnitName, classes }) => {
    if (!scheduleDate || !suggestedScheduleDate) {
        return null;
    }
    const differenceScheduleDateAndSuggestedDate = moment(scheduleDate).diff(
        moment(suggestedScheduleDate),
        "days"
    );
            ...
            <div className={classes.textBox}>
                ...
                <div className={classes.textLine}>
                    ...
                    it can be adjusted if needed.`)
                        : i18n.t("This date is {{count}} days {{position}} the suggested date.", {
                              position:
                                  differenceScheduleDateAndSuggestedDate > 0
                                      ? i18n.t("after")
                                      : i18n.t("before"),
                ...
                <div className={classes.textLine}>
                    {i18n.t("There are {{count}} scheduled event in {{orgUnitName}} on this day.", {
                        ...
                        defaultValue_plural:
                            "There are {{count}} scheduled events in {{orgUnitName}} on this day.",
                        interpolation: {
                            escape: false,
                        },
                    })}
...
export const InfoBox = withStyles(styles)(InfoBoxPlain);
