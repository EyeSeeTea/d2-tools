...
const WidgetEventSchedulePlain = ({
    ...
    <div className={classes.wrapper}>
        ...
        <DataSection dataTest="comment-section" sectionName={i18n.t("Event comments")}>
            <CommentSection
                comments={comments}
        ...
        />
        <ScheduleText programName={programName} stageName={stageName} orgUnitName={orgUnit?.name || ""} />
    </div>
);
