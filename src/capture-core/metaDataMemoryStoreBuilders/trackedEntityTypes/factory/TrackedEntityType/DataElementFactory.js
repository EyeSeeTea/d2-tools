...
export class DataElementFactory {
    ...
    async build(cachedTrackedEntityTypeAttribute) {
        const cachedAttribute =
            cachedTrackedEntityTypeAttribute.trackedEntityAttributeId &&
            this.cachedTrackedEntityAttributes.get(cachedTrackedEntityTypeAttribute.trackedEntityAttributeId);
            ...
            dataElement.unique = new DataElementUnique(o => {
                ...
                o.onValidate = (value, contextProps = {}) => {
                    ...
                    if (contextProps.onGetUnsavedAttributeValues) {
                        const unsavedAttributeValues = contextProps.onGetUnsavedAttributeValues(
                            dataElement.id
                        );
