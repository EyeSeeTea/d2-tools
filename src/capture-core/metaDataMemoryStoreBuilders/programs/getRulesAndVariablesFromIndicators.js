...
function buildIndicatorRuleAndVariables(programIndicator, programId) {
...
export function getRulesAndVariablesFromProgramIndicators(cachedProgramIndicators, programId) {
