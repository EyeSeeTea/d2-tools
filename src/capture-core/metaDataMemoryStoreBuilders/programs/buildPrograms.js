...
function getPrograms(storageController, storeName) {
    return storageController.getAll(storeName);
}

function getProgramRulesVariables(storageController, storeName) {
    return storageController.getAll(storeName);
}

function getProgramRules(storageController, storeName) {
    return storageController.getAll(storeName);
}

function getProgramIndicators(storageController, storeName) {
    return storageController.getAll(storeName);
}

function getRelationshipTypes(storageController, storeName) {
    return storageController.getAll(storeName);
}

function getCategories(storageController, storeName) {
...
function addProgramVariables(d2ProgramRulesVariables) {
...
function addProgramRules(d2ProgramRules) {
...
function addRulesAndVariablesFromProgramIndicators(cachedProgramIndicators) {
...
export async function buildPrograms({
    ...
    postProcessPrograms(programs, cachedProgramRulesVariables, cachedProgramRules, cachedProgramIndicators);
}
