...
export class DataElementFactory {
    ...
    static buildtetFeatureType(featureType) {
    ...
    static _buildDataElementUnique(dataElement, cachedTrackedEntityAttribute) {
        return new DataElementUnique(o => {
            ...
            o.onValidate = (value, contextProps = {}) => {
    ...
    async _setBaseProperties(dataElement, cachedProgramTrackedEntityAttribute, cachedTrackedEntityAttribute) {
    ...
    async _buildBaseDataElement(cachedProgramTrackedEntityAttribute, cachedTrackedEntityAttribute) {
    ...
    async _buildDateDataElement(cachedProgramTrackedEntityAttribute, cachedTrackedEntityAttribute) {
    ...
    build(cachedProgramTrackedEntityAttribute) {
