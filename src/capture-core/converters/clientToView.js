...
function convertDateForView(rawValue) {
    const momentDate = moment(rawValue);
    return convertMomentToDateFormatString(momentDate);
}

function convertDateTimeForView(rawValue) {
    const momentDate = moment(rawValue);
...
function convertTimeForView(rawValue) {
    const momentDate = moment(rawValue, "HH:mm", true);
    return momentDate.format("HH:mm");
}

function convertResourceForView(clientValue) {
    return (
        <a
