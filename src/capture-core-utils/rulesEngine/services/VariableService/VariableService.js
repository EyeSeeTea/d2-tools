...
export class VariableService {
    ...
    constructor(onProcessValue, dateUtils, environment) {
        ...
        this.mapSourceTypeToGetterFn = {
            ...
            [variableSourceTypes.DATAELEMENT_NEWEST_EVENT_PROGRAM_STAGE]:
                this.getVariableForNewestEventProgramStage,
    ...
    buildVariable(
        value,
        type,
        { variablePrefix, allValues, variableEventDate, useNameForOptionSet = false }
    ) {
    ...
    getVariableForSelectedEntityAttributes(programVariable, sourceData) {
        ...
        const attributeValue = sourceData.selectedEntity
            ? sourceData.selectedEntity[trackedEntityAttributeId]
            : null;

        const valueType =
            programVariable.useNameForOptionSet && attribute.optionSetId ? "TEXT" : attribute.valueType;
